...
export const HeroSection = () => {
  ...
  return (
    <section className="relative flex items-center justify-center overflow-hidden rice-paper-texture py-28 lg:py-36">
      ...
      <div className="container mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          {/* Text Content */}
          <div className={`space-y-6 lg:space-y-8 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}>
            ...
            <div className="flex flex-wrap gap-4">
              <Button
                ...
                size="lg"
                className="group"
                onClick={() => navigate('/programs')} // Navigate to Programs page
              >
              ...
              <Button
                ...
                onClick={() => navigate('/art-for-sdgs')} // Navigate to ArtForSDGs page
              >
          ...
          {/* Hero Artwork */}
          <div className={`relative transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-6'}`}>
